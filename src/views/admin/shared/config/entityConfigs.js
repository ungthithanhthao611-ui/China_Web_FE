...
export const ENTITY_MANAGER_CONFIGS = {
  ...
  content_blocks: {
    ...
    recordDisplayName: (record) => {
      const translations = {
        ...
        'speech_profile': '6. Ảnh lớn bên phải Tầm Nhìn & Chiến Lược',
        'speech_body': '7. Văn bản Tầm Nhìn & Chiến Lược',
  ...
  content_block_items: {
    ...
    recordDisplayName: (record) => {
      const translations = {
        ...
        'portrait': 'Ảnh lớn bên phải Tầm Nhìn & Chiến Lược',
    ...
    optionLabel: (option, field) => {
      if (field === 'block_id') {
        const translations = {
          ...
          'Chairman Portrait': '5. Ảnh lớn bên phải Tầm Nhìn & Chiến Lược',
          'Chairman\'s Speech Text': '6. Văn bản Tầm Nhìn & Chiến Lược',
  ...
  banners: {
    ...
    fieldLabels: {
      ...
      show_title: 'admin.entities.banners.fields.show_title',
      subtitle: 'admin.entities.banners.fields.subtitle',
      show_subtitle: 'admin.entities.banners.fields.show_subtitle',
      body: 'admin.entities.banners.fields.body',
      show_body: 'admin.entities.banners.fields.show_body',
    ...
    helpText: {
      show_title: 'Tích chọn để hiện Tiêu đề Banner ngoài giao diện public.',
      show_subtitle: 'Tích chọn để hiện Phụ đề ngoài giao diện public.',
      show_body: 'Tích chọn để hiện phần Mô tả ngoài giao diện public.',
