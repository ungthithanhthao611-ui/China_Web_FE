...
export const ENTITY_MANAGER_CONFIGS = {
  ...
  content_blocks: {
    ...
    recordDisplayName: (record) => {
      const translations = {
        'hero_summary': '1. Tóm tắt Tiêu đề đầu trang',
        'hero_nav': '2. Thanh điều hướng nội bộ',
        'intro_media': '3. Hình ảnh/Video Giới thiệu',
        'intro_video': '4. Nút bấm Video giới thiệu',
        'intro_paragraphs': '5. Các đoạn văn Giới thiệu',
        'speech_profile': '6. Ảnh chân dung Lãnh đạo',
        'speech_body': '7. Nội dung Tầm nhìn & Sứ mệnh',
        'speech_signature': '8. Chữ ký Lãnh đạo',
        'org_chart_image': '9. Khối Sơ đồ tổ chức',
        'culture_purpose': '10. Mục tiêu chiến lược',
        'culture_mission': '11. Sứ mệnh doanh nghiệp',
        'culture_spirit': '12. Tinh thần doanh nghiệp',
        'culture_values': '13. Giá trị cốt lõi',
        'timeline': '14. Lịch sử phát triển (Timeline)',
        'leadership_care_gallery': '15. Album ảnh Ban lãnh đạo',
      }
  ...
  content_block_items: {
    ...
    recordDisplayName: (record) => {
      const translations = {
        'about us': '1. Tiêu đề: GIỚI THIỆU CHUNG',
        'company introduction': '2. Nội dung: Giới thiệu công ty',
        'company introduction cover': 'Ảnh bìa Giới thiệu (Kho hàng)',
        'video +': '3. Nút bấm xem VIDEO',
        'paragraph 1': '4. Đoạn văn nội dung 1',
        'paragraph 2': 'Đoạn văn nội dung 2',
        'chairman portrait': '5. Ảnh chân dung Lãnh đạo',
        'chairman\'s portrait': '5. Ảnh chân dung Lãnh đạo',
        'chairman of china decoration co., ltd': 'Tiểu sử Lãnh đạo (Tên)',
        'chairman signature': 'Ảnh chữ ký Lãnh đạo',
        'organization chart image': '6. Hình ảnh Sơ đồ tổ chức',
        'organization chart': 'Sơ đồ tổ chức',
        'customer satisfaction': '7. Mục: Sự hài lòng khách hàng',
        'corporate purpose': 'Mục tiêu chiến lược',
        'corporate mission': 'Sứ mệnh doanh nghiệp',
        'corporate culture': 'Văn hóa & Giá trị cốt lõi',
        'headline': 'Dòng tiêu đề chính',
        'description': 'Đoạn mô tả tóm tắt',
        'cover_image': 'Ảnh nền/Ảnh bìa chính',
        'video_button': 'Nút xem Video (VIDEO+)',
        'video_url': 'Link Video YouTube/MP4',
        'portrait': 'Ảnh chân dung',
        'signature_image': 'Ảnh chữ ký',
        'main_chart': 'Ảnh Sơ đồ tổ chức chính',
        'sign_name': 'Họ tên người ký',
        'sign_title': 'Chức vụ người ký',
      }
      const rawKey = String(record?.title || record?.item_key || '').toLowerCase().trim();
      return translations[rawKey] || (record?.title || record?.item_key || '');
    },
    ...
    optionLabel: (option, field) => {
      if (field === 'block_id') {
        const translations = {
          'About Hero Summary': '1. Tên công ty & Slogan (Đầu trang)',
          'About Navigation Tabs': '2. Các tab chuyển mục',
          'Company Introduction Media': '3. Ảnh/Video mục Giới thiệu',
          'Company Introduction Text': '4. Văn bản mục Giới thiệu',
          'Chairman Portrait': '5. Ảnh lãnh đạo (Tầm nhìn/Sứ mệnh)',
          'Chairman\'s Speech Text': '6. Văn bản Tầm nhìn & Sứ mệnh',
          'Chairman Signature': '7. Chữ ký lãnh đạo',
          'Organization Chart': '8. Sơ đồ tổ chức',
          'Corporate Purpose': '9. Văn bản Tầm nhìn',
          'Corporate Mission': '10. Văn bản Sứ mệnh',
          'Corporate Culture': '11. Giá trị cốt lõi',
          'Development Course Timeline': '12. Lịch sử phát triển (Timeline)',
          'Leadership Care Gallery': '13. Ban lãnh đạo (Tên + Ảnh + Chức vụ)',
        }
