...
import { useEntityManager } from '@/admin/shared/composables/useEntityManager.js'
import EntityManagerConfirmDialog from '@/admin/shared/components/CoreConfirmDialog.vue'
import EntityManagerEditor from '@/admin/shared/components/AdminCoreEditor.vue'
import EntityManagerFilters from '@/admin/shared/components/CoreFilters.vue'
import EntityManagerRecordsTable from '@/admin/shared/components/CoreRecordsTable.vue'
import EntityManagerToolbar from '@/admin/shared/components/CoreToolbar.vue'
import EntityManagerUploadPanel from '@/admin/shared/components/CoreUploadPanel.vue'
...
<style scoped>
@import '@/admin/shared/components/AdminCoreManager.css';
</style>
