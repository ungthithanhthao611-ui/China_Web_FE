...
import { ChevronRight, Home, Search, X, SlidersHorizontal } from 'lucide-vue-next'
import { uiState } from '@/shared/utils/uiState'
import { listProductCategories, listProducts } from '@/client/services/productsApi'
  ...
  <div class="products-page">
    ...
    <section class="prod-hero">
      ...
      <div class="prod-hero__content">
        <p class="prod-hero__eyebrow">China Decor</p>
        ...
        <div v-else class="prod-grid">
          ...
          >
            <router-link :to="`/products/${product.slug}`" class="prod-card__img-wrap">
              <img
                :src="product.images?.[0]?.url || 'https://via.placeholder.com/400x300/f0ebe3/999?text=No+Image'"
                :alt="product.name"
                loading="lazy"
              />
